...
Light::Light(const glm::vec3& position, const glm::ivec3& intensity, const glm::ivec3& ambientLight)
    : position(position), intensity(intensity), ambientLight(ambientLight) {}
...
// Define o metodo getAmbientLight da classe Light
...
glm::ivec3 Light::getAmbientLight() const {
    return ambientLight;
}